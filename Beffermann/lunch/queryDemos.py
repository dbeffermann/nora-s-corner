...
firstEmployee = Customer.objects.first()

#(3)Returns last customer in table
lastEmployee = Customer.objects.last()

#(4)Returns single customer by name
employeeByName = Customer.objects.get(name='Peter Piper')

#***(5)Returns single customer by name
employeeById = Customer.objects.get(id=4)
